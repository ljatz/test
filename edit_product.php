<?php
	...
	if(Input::exists()) {
		$validate = $validation->check(array(
			...
			if($validate->passed()) {
				$update = DB::getInstance()->update('products', $values = array(
					'title' => Input::get('title'),
					'info' => Input::get('info')), get_id());
			...
			<div class="panel-body">
				<form method="post">
					...
					<div class="text-center">
						...
						<?php echo '<button type="button" class="btn btn-default"><a href="delete_product.php?id=' . get_id() . '">Delete product</a></button> <button type="submit" class="btn btn-default">Save changes</button>';
						?>
					</div>
				</form>
			</div>
