<?php
	...
	// uzima vrijeme početka sesije i određuje kraj za sat vremena, ako se ne kupi nakon sat vremena sesija se briše ili ako korisnik abortira konekciju sesija se briše, ako kupi sesija se sprema u tablicu usera a u session se briše
	
	/*$x = Cookie::put('test', 'test_value', 60); // 3600 = 1h
